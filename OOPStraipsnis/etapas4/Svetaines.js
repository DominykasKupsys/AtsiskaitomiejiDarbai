...
document.getElementById("Straipsnis").innerHTML = Rubrika.generavimas_rubrikos() + Rubrika2.generavimas_rubrikos()
+ Rubrika3.generavimas_rubrikos() + Rubrika4.generavimas_rubrikos() + Rubrika5.generavimas_rubrikos()